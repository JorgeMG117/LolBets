...
class LeagueData {
    fun loadLeagues(): List<League> {
        return listOf<League>(
            ...
            League(R.string.team_name_madlions, R.drawable.mad),
            League(R.string.team_name_g2, R.drawable.g2),

            League(R.string.team_name_astralis, R.drawable.astralis),
            League(R.string.team_name_bds, R.drawable.bds),
